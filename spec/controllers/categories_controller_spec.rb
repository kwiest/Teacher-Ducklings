...
describe CategoriesController do
  describe 'GET show' do
    ...
    it 'should assign the category and include posts' do
      Category.should_receive(:find_with_posts_and_links).with(category.id.to_s) { category }
    ...
    it 'should redirect if the category is not found' do
      Category.should_receive(:find_with_posts_and_links).with(category.id.to_s) { raise ActiveRecord::RecordNotFound }
